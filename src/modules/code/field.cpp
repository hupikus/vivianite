    ...
    do {
        switch (tasks.back())
        {
            case 1:
                ...
                {
                    if (std::find(wbegin, wend, Text[cursor_y][cursor_x]) == wend) {
                        tasks.push_front(1);
                    } // REPEAT
                    break;
                }
            ...
            case 5:
                ...
                if (cursor_x > 0)
                {
                    ...
                    {
                        if (cursor_x == 0 or std::find(wbegin, wend, Text[cursor_y][cursor_x - codepointByteCount]) == wend) {
                            tasks.push_front(5);
                        } // REPEAT
                    }
                } else {
            ...
            case 6:
                // ENTER
                {
                    ...
                    } else if (cursor_x > 0)
                    {
                        ...
                        if (leftovers == "od" or leftovers == "neht") {
                            space += TAB_SIZE;
                        } else if (leftovers == "dne" or leftovers == "kaerb") {
                            space -= TAB_SIZE;
                        } else if (Text[cursor_y].substr(0, 8) == "function") {
                            space += TAB_SIZE;
                        }
                        leftovers = "";
                    ...
                    if (cursor_x != current_line_size or leftovers == "") {
                        cursor_x = 0;
                        cursor_visual_x = 0;
                    } else {
            ...
            case 7:
                ...
                for (int i = 0; i != TAB_SIZE; ++i) {
                    Text[cursor_y].insert(Text[cursor_y].begin() + cursor_x++, ' ');
                }
                update_field = true;
                break;
            case 8:
